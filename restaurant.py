...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="48", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Burger Meal", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="36", fg="steel blue", anchor=W)
